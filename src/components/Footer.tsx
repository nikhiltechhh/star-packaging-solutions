  ...
  const handleNavClick = (href) => {
    if (href.startsWith("#")) {
      ...
      if (el) {
        ...
        window.location.href = `/${href}`; // fallback if section not found
      }
    } else {
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <img
              ...
              alt="Star Packaging"
              className="h-12 w-auto mb-6 brightness-200"
            />
          ...
          <div>
            <h4 className="font-body text-[10px] uppercase tracking-editorial text-background/40 mb-6">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              {["Bags Collection", "Food Packaging", "Gift Boxes", "Eco-Friendly"].map(
                (c) => (
                  <span key={c} className="font-body text-sm text-background/60">
                    {c}
                  </span>
                )
              )}
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a
                href="mailto:starpackaging.bm@gmail.com"
                className="flex items-center gap-3 font-body text-sm text-background/60 hover:text-background transition-colors"
              >
                <Mail className="w-4 h-4 shrink-0 stroke-[1.5]" /> starpackaging.bm@gmail.com
              </a>
              <a
                href="https://www.starpackaging.com"
                target="_blank"
